                ...
                <div class="row justify-content-center">
                    <div class="col-xl-8">
                        ...
                        <div class="font-back-tittle mb-45">
                            ...
                            <h3 class="archivment-back">Hotal Room Booking</h3>
                        </div>
                    </div>
                </div>
                <div class="row justify-content-center">
                        ...
                        <div class="select-this">
                                <div class="select-itms">
                                    <select name="select" id="select2" onchange="showValue(this.value)">
                                      ...
                                      <?php
                                      $result = mysql_query("SELECT DISTINCT city FROM hotel;");
        ...
        <script>
              function showValue(str) {
                if (str == "") {
                  ...
                  xmlhttp.open("GET","show_cname.php?q="+str,true);
                  xmlhttp.send();
                }
              }
            </script>
