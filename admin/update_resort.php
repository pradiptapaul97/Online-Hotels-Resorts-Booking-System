...
<head>
  ...
  function showValue(str) {
    if (str == "") {
      ...
      xmlhttp.open("GET","getresortup.php?q="+str,true);
      xmlhttp.send();
    }
  }
</script>
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Dashboard/Update-Resort</h1>
          </div>

        </div>
        <!-- /.container-fluid -->
                <!-- /.container-fluid -->
                <form class='user' method='POST' action='update_resort_db.php'>
                <div class="p-5">
                  <div class="text-center">
                    <h1 class="h4 text-gray-900 mb-4">Update Resort</h1>
                  </div>
