      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Admin Dashboard/View Hotel Booking</h1>
          </div>
          ...
          <?php
            ...
            $result = mysql_query("SELECT ID,NAME,CITY,TYPE,ROOM_NO,EMAIL,R_COST,DATE_FROM,DATE_TO,CARD,STATUS FROM HOTEL_BOOK");
