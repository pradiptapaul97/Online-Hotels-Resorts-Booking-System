...
<head>
  ...
  function showValue(str) {
    if (str == "") {
      ...
      xmlhttp.open("GET","getroomup.php?q="+str,true);
      xmlhttp.send();
    }
  }
</script>
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Dashboard/Update-Room</h1>
          </div>

        </div>
        <!-- /.container-fluid -->
        <form class='user' method='POST' action='update_room_db.php'>
                <div class="p-5">
                  ...
                  <div class="user" style="padding-left: 100px;padding-right: 100px;">
                    ...
                    <br>
                    <input type='submit' name='submit' value='Update Room' class='btn btn-primary btn-user btn-block'>
