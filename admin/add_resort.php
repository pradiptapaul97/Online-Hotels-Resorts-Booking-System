      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Dashboard/add-Resort</h1>
          </div>
        ...
        <!-- /.container-fluid -->
                <div class="p-5">
                  <div class="text-center">
                    <h1 class="h4 text-gray-900 mb-4">Add Resort</h1>
                  </div>
                  <form class="user" style="padding-left: 100px;padding-right: 100px;" method="POST" action="add_resort_db.php" enctype="multipart/form-data">
                    <div class="form-group">
                      <label><h4>Enter Resort Name </h4></label>
                      <input type="text" class="form-control" id="exampleInputEmail" aria-describedby="emailHelp" placeholder="Enter Resort name" name="resort_name">
                    </div>
                    <div class="form-group">
                      <label><h4>Enter City/State Name </h4></label>
                      <input type="text" class="form-control" id="exampleInputEmail" aria-describedby="emailHelp" placeholder="Enter city name" name="resort_city">
                    </div>

                    <br>

                      <label><h4>Select Resort Type</h4></label>
                      <select class='form-control' name='resort_type'>
                        <option value='' hidden selected>Select Resort Type :-</option>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="exampleInputEmail" aria-describedby="emailHelp" placeholder="Enter Resort Price" name="resort_price">
                    </div>

                    <br>
                    <div class="form-group">
                      <label><h4>Enter Resort Image</h4></label>
                      <input type="file" name="image" />
                    </div>
                    <br>
                    <input type="submit" name="submit" value="Add Resort" class="btn btn-primary btn-user btn-block">
