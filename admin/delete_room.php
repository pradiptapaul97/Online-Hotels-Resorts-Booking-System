...
<head>
  ...
  function showValue(str) {
    if (str == "") {
      ...
      xmlhttp.open("GET","getroomdel.php?q="+str,true);
      xmlhttp.send();
    }
  }
</script>
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Dashboard/Delete-Room</h1>
          </div>

        </div>
        <!-- /.container-fluid -->
        <form class='user' method='POST' action='delete_room_db.php'>
                <div class="p-5">
                  <div class="text-center">
                    <h1 class="h4 text-gray-900 mb-4">Delete Room</h1>
                  </div>
                  <div class="user" style="padding-left: 100px;padding-right: 100px;">
                    <div class="form-group">
                      <label><h4>Select Room Id </h4></label>
                      <select class="form-control" name="room_id" onchange="showValue(this.value)">
                        <option value="" hidden selected>Select a Room :-</option>
                        <?php 
                    ...
                    <br>
                    <input type='submit' name='submit' value='Delete Room' class='btn btn-primary btn-user btn-block'>
