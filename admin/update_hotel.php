...
<head>
  ...
  function showValue(str) {
    if (str == "") {
      ...
      xmlhttp.open("GET","gethotelup.php?q="+str,true);
      xmlhttp.send();
    }
  }
</script>
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Dashboard/Update-Hotal</h1>
          </div>

        </div>
        <!-- /.container-fluid -->
        <form class='user' method='POST' action='update_hotel_db.php'>
                <div class="p-5">
                  <div class="text-center">
                    <h1 class="h4 text-gray-900 mb-4">Update Hotel</h1>
                  </div>
