...
<head>
  ...
  function showValue(str) {
    if (str == "") {
      ...
      xmlhttp.open("GET","gethotelinf.php?q="+str,true);
      xmlhttp.send();
    }
  }
</script>
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Dashboard/Add-Room</h1>
          </div>

        </div>
        <!-- /.container-fluid -->
        <form class='user' method='POST' action='add_room_db.php' enctype="multipart/form-data">
                <div class="p-5">
                  <div class="text-center">
                    <h1 class="h4 text-gray-900 mb-4">Add Room</h1>
                  </div>
                  <div class="user" style="padding-left: 100px;padding-right: 100px;">
                    <div class="form-group">
                      <label><h4>Select Hotel Id </h4></label>
                      <select class="form-control" name="hotel_id" onchange="showValue(this.value)">
                        <option value="" hidden selected>Select a Hotel :-</option>
                        <?php 
                            $result = mysql_query("SELECT id,name,city FROM hotel");
                    ...
                    <br>
                      <div class="form-group">
                      <label><h4>Enter Hotel Room Image</h4></label>
                      <input type="file" name="image" />
                    </div>
                    <br>
                    <input type='submit' name='submit' value='Add Room' class='btn btn-primary btn-user btn-block'>
