      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Dashboard/add-Hotal</h1>
          </div>
        ...
        <!-- /.container-fluid -->
                <div class="p-5">
                  <div class="text-center">
                    <h1 class="h4 text-gray-900 mb-4">Add Hotel</h1>
                  </div>
                  <form class="user" style="padding-left: 100px;padding-right: 100px;" action="add_hotel_db.php" method="POST" enctype="multipart/form-data">
                    <div class="form-group">
                      <label><h4>Enter Hotel Name </h4></label>
                      <input type="text" class="form-control" id="exampleInputEmail" aria-describedby="emailHelp" placeholder="Enter Hotel name" name="hotel">
                    </div>
                    <div class="form-group">
                      <label><h4>Enter City Name </h4></label>
                      <input type="text" class="form-control" id="exampleInputEmail" aria-describedby="emailHelp" placeholder="Enter city name" name="city">
                    </div>
                    <br>
                      <div class="form-group">
                      <label><h4>Enter Hotel Image</h4></label>
                      <input type="file" name="image" />
                    </div>
                    <br>
                    <input type="submit" name="submit" value="Add Hotel" class="btn btn-primary btn-user btn-block">
