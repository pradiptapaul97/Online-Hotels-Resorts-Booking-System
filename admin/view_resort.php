      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Admin Dashboard/View Resorts</h1>
          </div>
          ...
          <?php
            ...
            $result = mysql_query("SELECT ID,NAME,CITY,TYPE,PRICE,RESORT_IMG FROM RESORT");
            while($row = mysql_fetch_array($result))
            {
              ...
              echo "
                    <tr>
                      ...
                      <td>".$row['TYPE']."</td>
                      <td>".$row['PRICE']."</td>
                      <td><img src='images/".$row['RESORT_IMG']."' height = '130px' width = '200px'></td>
                    </tr>";
            }
            mysql_close($con);
          ?>
