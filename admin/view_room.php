      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Admin Dashboard/View Rooms</h1>
          </div>
          ...
          <?php
            ...
            $result = mysql_query("SELECT ROOM_ID,HOTEL_ID,ROOM_TYPE,ROOM_PRICE,ROOM_NO,ROOM_IMAGE FROM ROOM");
            while($row = mysql_fetch_array($result))
            {
              ...
              echo "
                    <tr>
                      ...
                      <td>".$row['ROOM_NO']."</td>
                      <td><img src='images/".$row['ROOM_IMAGE']."' height = '130px' width = '500px'></td>
                    </tr>";
            }
            mysql_close($con);
          ?>
